...
class SecretsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create secret" do
    assert_difference("Secret.count") do
      post secrets_url, params: { secret: { content: @secret.content, title: @secret.title } }
    end
  ...
  test "should update secret" do
    patch secret_url(@secret), params: { secret: { content: @secret.content, title: @secret.title } }
